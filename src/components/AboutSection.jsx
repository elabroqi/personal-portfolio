...
//import resumePdf from "@/assets/AB_Resume_.pdf";
                        ...
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    <h4 className="font-semibold text-lg">Research & Development Intern</h4>
                                    <p className="text-sm text-muted-foreground">
                                        Institute of Simulation & Training
                                    </p>

                                    {/* combined bullets */}
                                    <ul className="list-disc list-inside text-md mt-1 space-y-2">
                                        <li>
                                            Developed and deployed software components supporting simulation based training systems.
                                        </li>
                                        <li>
                                            Containerized and deployed OpenWebUI using Docker configuring host level networking to enable centralized access.
                                        </li>
                                        <li>
                                            Implemented C# scripts in Unity to support interactive training simulations and performance driven system behavior.

                                        </li>
                                        <li>
                                            Analyzed and documented military training elements into quantifiable scenario complexity metrics, supporting backend design planning for a shooting range simulation and reducing manual tuning efforts by an estimated 50%.
                                        </li>
                                        <li>
                                            Utilized Unreal Engine to enhance immersive features for virtual reality interactions.
                                        </li>
                                    </ul>
                                    ...
                                    <p className="mt-2 font-semibold text-sm text-muted-foreground">
                                        May 2025 – Present
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-md text-muted-foreground">
                                        Bachelor of Science in Computer Science student with coursework in Data
                                        Structures, Operating Systems, and Systems Software.
                                    </p>
                                    <p className="mt-2 font-semibold text-sm text-muted-foreground">
                                        August 2022 – Present
                                    </p>
